...
const Contact = () => {
  ...
  return (
    <div className="w-full">
      <Header />
      <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 pt-24">
        {/* Hero Section */}
        <div className="w-full bg-gradient-to-r from-blue-600 to-purple-700 text-white py-16">
          <div className="w-full px-8">
            <div className="w-full max-w-4xl mx-auto text-center space-y-6 animate-in fade-in duration-1000">
        ...
        <div className="w-full px-8 py-16">
          <div className="w-full max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-16">
              {/* Office Address */}
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 animate-in slide-in-from-left duration-1000">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-4">Office Address</h3>
              ...
              {/* Phone Numbers */}
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 animate-in slide-in-from-bottom duration-1000 delay-200">
                ...
                <div className="space-y-2">
                  <p className="text-gray-600 text-lg">+91 9160040202</p>
                  <p className="text-gray-600 text-lg">+91 9822422584</p>
                </div>
              </div>

              {/* Email Addresses */}
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 animate-in slide-in-from-right duration-1000 delay-400">
                ...
                <div className="space-y-2">
                  <p className="text-gray-600 text-lg">sales@s2overseas.com</p>
                  <p className="text-gray-600 text-lg">info@s2overseas.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8 animate-in slide-in-from-left duration-1000">
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                  <h2 className="text-3xl font-bold text-gray-800 mb-6">Send Your Inquiry</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg text-lg"
                    >
                      SEND INQUIRY
                    </Button>
                  </form>
              ...
              <div className="space-y-8 animate-in slide-in-from-right duration-1000 delay-300">
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                  <h2 className="text-3xl font-bold text-gray-800 mb-6">Top Questions</h2>
                  <p className="text-gray-600 mb-8">Need Help? Find Answers to Common Questions Before Reaching Out</p>
                  
                  <div className="space-y-6">
                    <div className="border-l-4 border-blue-500 pl-6">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">Which countries do you export to?</h3>
                    ...
                    <div className="border-l-4 border-green-500 pl-6">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">What are your payment terms and options?</h3>
                      <p className="text-gray-600">
                    ...
                    <div className="border-l-4 border-orange-500 pl-6">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">How long does it take to process and ship an order?</h3>
                      <p className="text-gray-600">
                    ...
                    <div className="border-l-4 border-purple-500 pl-6">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">Can I track my shipment once it's dispatched?</h3>
                      <p className="text-gray-600">
                  ...
                  <Button 
                    className="w-full mt-8 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300"
                  >
                    Have More Questions
                  </Button>
                </div>
